...
function getPopupClass(opts) {
    var PopupClass =  document.getElementById("tip-frame").checked ? 
        OpenLayers.Popup.TipFrame : OpenLayers.Popup.SideAnchored;
    return OpenLayers.Class(PopupClass, opts);
}

function getPopupOptions() {
    var anchor = document.getElementById("anchor-side").value.split("-");
    return {
        closeBox: document.getElementById("show-close-button").checked,
...
function onFeatureSelect(evt) {
    ...
    popup = new PopupClass("featurePopup",
                           ...
                           undefined, opts.popupClose, onPopupClose,
                           opts.relativePosition);
  popup.relativePosition = opts.relativePosition;
  feature.popup = popup;
